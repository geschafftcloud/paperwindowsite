...
import * as sty from "./PlasmicBaseCard.module.css"; // plasmic-import: HZS_tW2-nTFraP/css
...
function PlasmicBaseCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(defaultcss.all, sty.box__gbBIe, {
          [sty.box__long__gbBIeyImWz]: hasVariant(variants, "long", "long")
        })}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      {(hasVariant(variants, "long", "long") ? true : false) ? (
        <div
          className={classNames(defaultcss.all, sty.box___9Tnyc, {
            [sty.box__long___9TnyCyImWz]: hasVariant(variants, "long", "long")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(defaultcss.all, sty.svg__bZ5Rd)}
                role={"img"}
              />
            ),
