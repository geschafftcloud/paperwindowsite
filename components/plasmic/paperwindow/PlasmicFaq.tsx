...
import * as sty from "./PlasmicFaq.module.css"; // plasmic-import: sTsxpzSVR1gVN3/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__zaSaV)}
      >
        <div className={classNames(defaultcss.all, sty.box__sQrl)}>
          <div className={classNames(defaultcss.all, sty.box__yA8Qi)}>
            {p.renderPlasmicSlot({
