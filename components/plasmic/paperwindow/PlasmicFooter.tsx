...
import * as sty from "./PlasmicFooter.module.css"; // plasmic-import: hBadTY7hHvdiQ/css
...
function PlasmicFooter__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(defaultcss.all, sty.box__ympo0)} />

      <p.Stack
        as={"div"}
        hasGap={hasVariant(globalVariants, "screen", "mobile") ? true : false}
        className={classNames(defaultcss.all, sty.box__okYqQ)}
      >
        <div className={classNames(defaultcss.all, sty.box__kqWbQ)}>
          <p.PlasmicLink
          ...
          >
            {
              "© Geschafft Cloud. Code licensed under the Apache 2.0 Open Source License.\n"
            }
          </p.PlasmicLink>
        </div>
      </p.Stack>
