...
import * as sty from "./PlasmicIconLink.module.css"; // plasmic-import: HhEo-m8iH6QNO/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(defaultcss.all, sty.svg__h581D)}
              role={"img"}
            />
          ),
