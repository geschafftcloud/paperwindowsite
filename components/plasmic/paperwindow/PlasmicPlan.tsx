...
import BaseCard from "../../BaseCard"; // plasmic-import: HZS_tW2-nTFraP/component
import Bullet from "../../Bullet"; // plasmic-import: LZLS4ajdSxNxf1/component
...
import * as sty from "./PlasmicPlan.module.css"; // plasmic-import: Bfp-xsK-dKDE_f/css
...
function PlasmicPlan__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(defaultcss.all, sty.box__jSzp)}>
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__q1W1Y)}
        >
          {p.renderPlasmicSlot({
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(defaultcss.all, sty.box__wzoNb)}
              >
                <Bullet
                  className={classNames("__wab_instance", sty.bullet__qr8Xf)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet___1FG0D)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet___8VefE)}
                />
              </p.Stack>
            ),
          ...
          <div className={classNames(defaultcss.all, sty.box__jQdBz)}>
            {p.renderPlasmicSlot({
              defaultContents: (
                <LinkButton
                  text={"Get started"}
